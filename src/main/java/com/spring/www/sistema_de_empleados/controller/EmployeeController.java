...
import com.spring.www.sistema_de_empleados.service.EmployeeServiceImpl;
...
public class EmployeeController {
    ...
    @PostMapping("/nuevo")
    public String crearEmpleado(@Valid @ModelAttribute("employe") EmployeeCreateAndUpdateRequest request, BindingResult result){
    ...
    public String mostrarFormularioEditar(@PathVariable Integer empNo, Model model){
        ...
        if(employee.getDepartments() != null && !employee.getDepartments().isEmpty()) {
            DeptEmp deptEmp = employee.getDepartments().get(0);
